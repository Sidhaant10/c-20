...
def goal_track(img, bbox):
    global p1, p2  # use global variables to store previous ball coordinates
    ...
    p1 = c1  # update the previous x-coordinate with the current one
    p2 = c2  # update the previous y-coordinate with the current one
